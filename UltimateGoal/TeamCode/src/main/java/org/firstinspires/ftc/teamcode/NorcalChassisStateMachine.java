           ...
           //     spline.add(new Waypoint(94, 183, power));
             //   spline.add(new Waypoint(72, 194, power));
               ...
               // spline = new Spline(new Waypoint(120,180,power));
                ...
                //C
                //spline = new Spline(new Waypoint(100, 240, power));
//                spline.add(new Waypoint(85, 240, power));
//                spline.add(new Waypoint(75, 260, power));
                spline = new Spline(new Waypoint(75, 335, power));
            ...
            if(rings==0){
              ...
              spline = new Spline(new Waypoint(75, 235, power));
                ...
                //B
                spline = new Spline(new Waypoint(126,273,power));

            }
            else if (rings == 4){
                //C
                spline = new Spline(new Waypoint(70,331,power));
                spline.add(new Waypoint(74,335,power));
    ...
    public void moveToSecondWobble(){
        ...
        if(rings == 1){
            ...
            spline.add(new Waypoint(140,176,power));
            spline.add(new Waypoint(128,113,power));
            spline.add(new Waypoint(93,64, 0.8 * power));

        }
        else if(rings == 4){
            //starts from 60, 348
            spline = new Spline(new Waypoint(103,291,power));
            spline.add(new Waypoint(130,232,power));
            spline.add(new Waypoint(141,188,power));
            spline.add(new Waypoint(143,133,power));
...
/*            spline = new Spline(new Waypoint(152, 142, power));
            ...
            spline.add(new Waypoint(89,113,power));
            spline.add(new Waypoint(89,140,power));
*/
        }
        if (instance == 2) {
...
//            chassisComp.spinToXDegree(0, 0.005, .1);
    ...
    public void moveToPowerShot(){
        if(rings == 0){
            spline = new Spline(new Waypoint(142,95,power));
            spline.add(new Waypoint(156, 144, power));
            spline.add(new Waypoint(168, 195, power));
        }
        else if(rings == 1){
           spline = new Spline(new Waypoint(120, 170, power));
           spline.add(new Waypoint(170, 195, 0.8 * power));
        }
        else if(rings == 4){
            spline = new Spline(new Waypoint(89, 170, power));
            spline.add(new Waypoint(170, 195, 0.8 * power));
        }
